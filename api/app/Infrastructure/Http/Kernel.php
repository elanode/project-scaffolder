...
use App\Infrastructure\Http\Middleware\AttachCookiePassportMiddleware;
use App\Infrastructure\Http\Middleware\ReadCookiePassportMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        ReadCookiePassportMiddleware::class
    ];
    ...
    protected $routeMiddleware = [
        ...
        'passport' => AttachCookiePassportMiddleware::class,
